/*
* The class reads the flight-kafka property file in the resources
* */
...
public class PropertyFileReader {
    ...
    public static Properties readPropertyFile() throws Exception {
        if (prop.isEmpty()) {
            InputStream input = PropertyFileReader.class.getClassLoader().getResourceAsStream("flight-kafka.properties");
            try {
                prop.load(input);
